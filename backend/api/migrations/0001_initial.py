# Generated by Django 2.2.20 on 2022-10-30 20:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Чтобы приготовить банан, нужен хотя бы 1 ингредиент.')], verbose_name='Количество')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('#E26C2D', 'Красный'), ('#49B64E', 'Зеленый'), ('#8775D2', 'Фиолетовый')], max_length=7, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Меньше миинуты хватит только почистить банан')], verbose_name='Время приготовления')),
